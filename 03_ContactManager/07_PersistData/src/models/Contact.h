...
/**
 * @brief The Contact class represents a single contact entry with all associated data.
 *
 * This class encapsulates all information about a contact including personal details,
 * contact methods, metadata, and categorization. It provides JSON serialization support
...
public:
    ...
    int contactFrequency() const { return m_contactFrequency; }
    ...
    void setContactFrequency(int frequency);

    // Utility methods
    void addTag(const QString &tag);
    void removeTag(const QString &tag);
    bool hasTag(const QString &tag) const;
    void incrementContactFrequency();
    void touch(); // Updates dateModified to current time
