        ...
        ScrollView {
            ...
            GridView {
                ...
                Rectangle {
                    ...
                    height: 200
                    color: "transparent"
                    visible: repositoryGrid.count === 0 && !githubService.isLoading
                ...
                Rectangle {
                    anchors.fill: parent
                    color: Qt.alpha(appTheme.background, 0.8)
                    visible: githubService.isLoading
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            RotationAnimation on rotation {
                                running: githubService.isLoading
                                from: 0
                                to: 360
                                duration: 1000
