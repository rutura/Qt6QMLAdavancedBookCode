...
public:
    ...
    void searchIssues(const QString &query, int page, int perPage,
                      const QString &sort = "created",
                      const QString &order = "desc");

    void searchUsers(const QString &query, int page, int perPage,
                     const QString &sort = "followers",
                     const QString &order = "desc");
...
signals:
    ...
    void issueSearchResultsReady(const QList<Issue*> &issues,
                                 int page, int totalCount);
    void userSearchResultsReady(const QList<User*> &users,
                                int page, int totalCount);
...
private slots:
    ...
    void onIssueSearchResultsReceived();    // NEW
    void onUserSearchResultsReceived();     // NEW

    void onCacheLoaded(const QString &key, const QByteArray &body, bool found);
