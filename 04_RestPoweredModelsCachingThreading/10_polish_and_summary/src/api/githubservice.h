...
class GitHubService : public QObject
{
    ...
    Q_PROPERTY(int rateLimitRemaining READ rateLimitRemaining NOTIFY rateLimitRemainingChanged)
    Q_PROPERTY(int rateLimitTotal READ rateLimitTotal NOTIFY rateLimitTotalChanged)
    Q_PROPERTY(QDateTime rateLimitReset READ rateLimitReset NOTIFY rateLimitResetChanged)
...
signals:
    ...
    void rateLimitRemainingChanged();
    void rateLimitTotalChanged();
    void rateLimitResetChanged();
...
private:
    ...
    QHash<QString, QString> m_etagByUrl;
